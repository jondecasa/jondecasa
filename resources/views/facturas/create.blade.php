...
<div class="container py-2">
    ...
    <form action="{{route("facturas.store")}}" method="POST" id="formularioFacturas">
        @csrf
        <div class="row">
            <div class="col-12 col-md-3">
                <strong>Nº Factura</strong>
                <input type="text" readonly id="numFactura" name="numFactura" class="form-control" value="{{$ultimaFactura->num}}">
            </div>
            <div class="col-12 col-md-3">
        ...
        <div class="row">
            <div class="col-12 col-md-3">
                <strong>Base</strong>
                <input type="number" name="base" class="form-control" readonly>
            </div>
            <div class="col-12 col-md-3">
                <strong>IVA</strong>
                <input type="number" name="iva" class="form-control" value="21">
            </div>
            <div class="col-12 col-md-3">
                <strong>Total</strong>
            ...
            <div class="col-12 col-md-3">
                ...
                <input type="number" name="retencion" class="form-control" value="15">
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-12 col-md-3 my-auto">
                ...
                <input type="checkbox" name="facturado">
            </div>
            <div class="col-12 col-md-3 my-auto">
            ...
            <div class="col-12 col-md-3 offset-md-3">
                ...
                <input type="number" readonly name="totalEur" class="form-control">
            </div>
        </div>
        <hr class="mt-2 mb-3"/>
        <div class="row">
